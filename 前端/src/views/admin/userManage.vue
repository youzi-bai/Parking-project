<template>
    <div id="userManage">
        ...
        <el-table  stripe :data="tableData" border style="width: 100%" 
            ...
            <el-table-column label="用户状态(1:使用中 0：未使用)" prop="stateUser" align="center">
                <template slot-scope="scope">
                    <i class="el-icon-user-solid"></i>
                    <span style="margin-left: 10px">{{ scope.row.stateUser }}</span>
                </template>
            </el-table-column>stateUser
                        ...
                        <el-col :span="8">
                            ...
                            <el-form-item label="性别" label-width="110px">
                             ...
                             <el-form-item label="状态" label-width="110px">
                                <el-input v-model="publishForm.stateUser" ></el-input>
                            </el-form-item>
                        </el-col>
