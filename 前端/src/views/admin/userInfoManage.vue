            ...
            <div style="margin-top:160px">
                <el-form :model="userForm"  label-position="left">
                    <el-form-item label="姓名" >
                        <el-input style="width:800px;margin-left:30px;float:left" v-model="userForm.nameUser" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="身份" >
                        <span style="float:left;margin-left:50px">{{identity}}</span>
                    </el-form-item>
                     <el-form-item label="个人简介">
                        <el-input v-model="userForm.content" clearable  style="width:800px;float:left"></el-input>
                    </el-form-item>
                     <el-form-item label="邮箱地址">
                        <el-input v-model="userForm.email" clearable style="width:800px;float:left" type="textarea"></el-input>
                    </el-form-item>
                    <el-form-item label="密码">
                        <el-input v-model="userForm.password" clearable type="password" style="width:800px;margin-left:30px;float:left"></el-input>
                    </el-form-item>
