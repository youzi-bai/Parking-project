                ...
                <el-form :model="userForm"  label-position="left">
                    ...
                    <el-form-item label="身份" >
                     ...
                     <el-form-item label="个人简介">
                        <el-input v-model="userForm.content" clearable  style="width:1240px;"></el-input>
                    </el-form-item>
                    <el-form-item label="地址">
                        <el-input v-model="userForm.address" clearable  style="width:1240px;"></el-input>
                    </el-form-item>
                    <el-form-item label="邮箱地址">
                        <el-input v-model="userForm.email" clearable style="width:1240px;" type="textarea"></el-input>
                    </el-form-item>
