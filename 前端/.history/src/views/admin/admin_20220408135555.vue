<template>
    <div id="admin">
         ...
         <el-container>
            <el-header style="height:80px;background: linear-gradient(to bottom, #cc86d1, #dcffbd)">
                <commen-header></commen-header>
            </el-header>
            <el-container>
                <el-aside width="180px" style="background: linear-gradient(to bottom, #cc86d1, #dcffbd)">
                  <el-menu :default-active="activeIndex" mode="vertical" background-color="white"
                    text-color="black" active-text-color="#cc86d1" border="1px solid black" @select="selectMenu">
                ...
                <el-main style="background:linear-gradient(to right, #cc86d1, #dcffbd)">
...
export default {
    ...
    created(){ 
      ...
      if(this.menuList==null || this.menuList.length==0){
          this.$alert('当前用户还未分配角色，可联系系统管理员角色为其配置角色菜单', '提示', {
